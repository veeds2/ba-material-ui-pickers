  ...
  _createClass(DateTimePickerWrapper, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ['value', 'format', 'autoOk', 'openTo', 'classes', 'minDate', 'maxDate', 'showTabs', 'autoSubmit', 'disablePast', 'disableFuture', 'returnMoment', 'invalidLabel', 'leftArrowIcon', 'rightArrowIcon', 'dateRangeIcon', 'timeIcon', 'renderDay', 'labelFunc', 'utils', 'ampm', 'minutesStep', 'shouldDisableDate', 'animateYearScrolling']);
