...
export var ClockNumber = function (_Component) {
  ...
  _createClass(ClockNumber, [{
    ...
    value: function render() {
      ...
      var className = classnames(classes.clockNumber, (_classnames = {}, _defineProperty(_classnames, classes.selected, selected), _defineProperty(_classnames, classes.visible, visible), _classnames));
